...
precos_array = np.genfromtxt("C:\\Users\\melo.thiago\\Documents\\BigData_Senac\\Exercicios\\vendas_produtos.csv", delimiter=',', skip_header=1, dtype=None, encoding='utf-8', usecols=3)
print(precos_array)
